...
int main(){
    char name1[] = "Coke" ;
    int price1 = 10, stock1 = 10 , selected1 = 0 ; //selected1 คือ ตัวแปรที่ใช้เก็บจำนวนสินค้าที่ลูกค้าสะสมทั้งหมดที่เลือกในแต่ละรอบ 

    char name2[] = "Fanta green" ;
    ...
    char name4[] = "Latte" ;
    int price4 = 30, stock4 = 10 , selected4 = 0 ;
 ...
 // จำนวนเงินที่มีในตู้
    ...
    do
    {
        ...
        if (choice == 1 && qty <= stock1) //ตรวจว่าผู้ใช้เลือกสินค้าหมายเลข 1 หรือไม่ and ตรวจว่าจำนวนที่เลือกไม่เกินจำนวนสินค้าที่เหลือในสต็อก
        {
        ...
        {
            printf ( "Please celect a menu(1-7)\n" ) ;
        }
    } while ( 1 ) ;
    ...
    // ---------- รับเงินลูกค้า ----------
    int paid = 0 ; //paid ตัวแปรเก็บจำนวนเงินที่ลูกค้าจ่าย(รวมสะสม)
    do
    {
        int addPay = 0 ; //addPay เพื่อเก็บ จำนวนเงินที่ลูกค้าจ่ายในแต่ละรอบ
